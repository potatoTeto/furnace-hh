...
class FurnaceGUI {
  ...
  String workingDirVGMExport, workingDirZSMExport, workingDirROMExport, workingDirMMLExport, workingDirFont, workingDirColors, workingDirKeybinds;
  ...
  void drawExportMml(bool onWindow=false);
